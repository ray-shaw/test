<template>
  ...
  <div class="ml-3">
    ...
    <transition name="fade">
      <div
        v-if="show"
        class="origin-top-left absolute left-0 right-0 mt-2 w-full bg-black text-white"
        role="menu"
      ...
      >
        ...
        <p
          ...
          class="px-4 py-2 cursor-pointer text-error"
          @click="signOutUser"
        >
          Logout
        </p>
